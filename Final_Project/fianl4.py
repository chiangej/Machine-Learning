...
one_day = data_process.read_data("20231201", station_id)
second_day = data_process.read_data("20231202", station_id)
dfs.append(one_day)
...
y_train = np.reshape(y_train, (576, 504))
print(x_train.shape)
print(y_train)
print(x_test)
...
data_frame.to_csv(f'{station_id}_new.csv', index=False)
print(data_frame)
